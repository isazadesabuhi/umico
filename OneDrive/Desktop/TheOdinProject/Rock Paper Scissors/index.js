...
function game() {
  ...
  for (let i = 0; i < 5; i++) {
    if (i === 0) {
      console.log("Let may chance be with you.");
    } else if (i === 4) {
      console.log("This is the last round. Are you sure with your decision??");
    }
  ...
  if (scorePlayer > scoreComputer) {
    console.log(`Player won ${scorePlayer}-${5 - scorePlayer}`);
  } else if (scorePlayer < scoreComputer) {
    console.log(`Computer won ${scoreComputer}-${5 - scoreComputer}`);
  } else {
